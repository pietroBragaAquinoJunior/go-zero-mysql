...
func (c *zrpcServiceClient) ZrpcMethod(ctx context.Context, in *ZrpcRequest, opts ...grpc.CallOption) (*ZrpcResponse, error) {
	out := new(ZrpcResponse)
...
type ZrpcServiceServer interface {
	ZrpcMethod(context.Context, *ZrpcRequest) (*ZrpcResponse, error)
...
func (UnimplementedZrpcServiceServer) ZrpcMethod(context.Context, *ZrpcRequest) (*ZrpcResponse, error) {
...
func _ZrpcService_ZrpcMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZrpcServiceServer).ZrpcMethod(ctx, req.(*ZrpcRequest))
	}
